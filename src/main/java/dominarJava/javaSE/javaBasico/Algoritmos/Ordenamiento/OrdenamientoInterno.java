...
public class OrdenamientoInterno {
    ...
    public void OrdenamientoBurbuja() {
        int numerosDesodenados[] = { 342, 12, 489, 21, 156, 401, 88, 12, 333, 4, 276, 490, 115, 67, 222, 19, 444, 312,
                8, 99,
    ...
    public int[] OrdenarInsercion(int[] listaDesordenada) {
        ...
        // no es buena practica pero es para entender unj poco
        // sobre las variables y el retorno
        int ListaOrdenada[] = listaDesordenada;
        return ListaOrdenada;
